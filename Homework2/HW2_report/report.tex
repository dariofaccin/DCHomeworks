...
\begin{figure}[H]
	...
	\node [coordinate, label={[label distance=0.2cm]90:$z(k)$}, right = 0.75 cm of intpl] (c1) {};
	...
	\node [coordinate, label={[label distance=0.2cm]100:$d(k)$}, right = 0.75cm of imp] (c2) {};
	
	\node [coordinate, label={[label distance=0.1cm]90:$w(k)$}, above = 1cm of sum] (wgn) {};
